...
#ifndef BULLETIN_AVERAGE_H_
#define BULLETIN_AVERAGE_H_

class BulletinAverage : public Observer {
  ...
  public:
    // default name: std::string("Average")
    BulletinAverage(Observable *weather_data, Name name)
